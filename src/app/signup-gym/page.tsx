...
export default function SignupGymPage() {
  ...
  return (
    <AuthHeroLayout
      eyebrow="Para dueños de gimnasios"
      title="Digitalizá tu gimnasio en minutos"
      description="Creá tu cuenta de administrador y empezá a gestionar clases, membresías y cobros desde el día uno."
    >
      {error && (
